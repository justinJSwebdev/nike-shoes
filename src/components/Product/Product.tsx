...
export default function Product() {
  return (
    <div className='flex flex-col items-center justify-center '>
      <Link
        to='/products'
        className='h-[360px] lg:h-[440px] flex justify-center items-center relative flex-shrink-0 bg-footer group transition duration-300'
      >
        <img
          src='../images/product1.png'
          alt='product'
          className='h-[500px] object-cover group-hover:blur-sm transition duration-300'
        />
        <div className='absolute inset-0 flex flex-col items-center justify-center transition duration-300 group-hover:bg-black/60'>
          <Link
            to='/'
